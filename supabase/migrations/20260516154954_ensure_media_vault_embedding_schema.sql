-- Repair / idempotent apply for memory embedding schema (see also 009_memory_embeddings.sql).
-- Safe to run if 009 was never pushed to the remote project.
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'memory_embeddings_select_own'
  ) THEN
